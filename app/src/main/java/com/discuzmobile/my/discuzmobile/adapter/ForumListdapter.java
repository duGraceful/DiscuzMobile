...
public class ForumListdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private List<ListBean> mLists;
    private RecyclerItemOnClickListener mRecyclerItemOnClickListener;

    public ForumListdapter(Context mContext, List<ListBean> mLists) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ViewHold mVocationHolder = new ViewHold(LayoutInflater.from(mContext).inflate(R.layout.item_forum_list_layout, parent, false));
    ...
    private class ViewHold extends RecyclerView.ViewHolder {
        ...
        public ViewHold(View itemView) {
            ...
            item_bg = (LinearLayout) itemView.findViewById(R.id.item_img_bg);
